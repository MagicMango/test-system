...
export default class TestSystemCharacter extends TestSystemActorBase {
  ...
  static defineSchema() {
    ...
    schema.abilities = new fields.SchemaField(Object.keys(TEST_SYSTEM.abilities).reduce((obj, ability) => {
  ...
  prepareDerivedData() {
    ...
    for (const key in this.abilities) {
      ...
      this.abilities[key].label = game.i18n.localize(TEST_SYSTEM.abilities[key]) ?? key;
    }
  }
